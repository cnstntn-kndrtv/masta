 ...
 */
var demoTxt = 'Выставка "Человек как птица. Образы путешествий" исследует вопросы новых открытий на стыке оптики и искусства, в тех сферах, которые объединены стремлением человека к познанию мира и определению своего места в нем. Экспозиция объединит творчество 14 российских и зарубежных художников, работающих в различных медиа: звуковые и световые инсталляции, видео, фото и объекты.'
